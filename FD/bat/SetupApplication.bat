...
:: Android packaging
set AND_CERT_NAME="exVideoPlayerSurface"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exVideoPlayerSurface.p12
...
set APP_ID=com.doitflash.exVideoPlayerSurface

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exVideoPlayerSurface
